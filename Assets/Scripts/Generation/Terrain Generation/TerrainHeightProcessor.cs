...
namespace TerrainGeneration
{
	public class TerrainHeightProcessor : MonoBehaviour
	{
		...
		public void ProcessHeightMap()
		{
			const int worldHeightsKernel = 0;

			GraphicsFormat format = GraphicsFormat.R16_UNorm;
			processedHeightMap = ComputeHelper.CreateRenderTexture(heightMap.width, heightMap.height, FilterMode.Bilinear, format, "World Heights");
